...
version = "v1.0"
group_username = "@Princes_log_support_group"
...
if ":" in BOT_TOKEN:
    ...
    print("HACKER X SPAM : Bot token 1 has been found")
else:
...
if BOT_TOKEN2:
    Client2 = call(
        ...
        plugins=dict(root="HACKER X SPAM.HACKER X SPAM"),
    )
    print("HACKER X SPAM : Bot token 2 Found")
else:
    Client2 = None
...
async def Start_BotSpam():
    for i in range(1, 26):
        ...
        if var is not None:
            await start_bot(var)
    print("➖➖➖➖➖➖➖➖➖➖➖➖")
    print(f"🔥 ᗷᝪᎢ ᔑᑭᗩᗰ 🔥[INFO] : Group Username {@O_P_Hacker}")
